...
#
# Usage:
#   ./train_segdet.sh --output OUTPUT_DIR [--model-size SIZE] [--epochs N]
...
DATA_YAML="${OUTPUT_DIR}/dataset_segdet.yaml"
RESULT_FILE="${OUTPUT_DIR}/result_segdet.json"
...
echo "============================================"
echo "  Train LibreSegDet-${MODEL_SIZE}"
echo "============================================"
echo "  Data:     $DATA_YAML"
echo "  Epochs:   $EPOCHS"
echo "  Batch:    $BATCH"
...
summary = {
    ...
    'best_mIoU': results.get('best_mIoU'),
...
echo ""
echo "LibreSegDet training complete. Results: $RESULT_FILE"
